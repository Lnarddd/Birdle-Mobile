...
public class Endurance_level_3_SpawnPoint : MonoBehaviour
{
    ...
    void spawn(){
        ...
        switch(spawnseed){
            ...
            case 4:
                ...
                break;
            case 5:
                Instantiate(obs6, new Vector3( Random.Range(0,10), 5, 0), Quaternion.identity);
                break;
            case 6:
                Instantiate(obs7, new Vector3( Random.Range(0,10), -5, 0), Quaternion.identity);
                break;
            case 7:
