...
public class Hard_Not_Target : MonoBehaviour
{
    ...
    private void OnMouseDown() {
        ...
        GameObject.Find("GameControl").GetComponent<Strength_Minigame_2>().wrong();
    ...
    public void KillSelf() {
        GameObject.Find("GameControl").GetComponent<Strength_Minigame_2>().spawntargets += 1;
        GameObject.Find("GameControl").GetComponent<Strength_Minigame_2>().itemtoremove = tagnumber;
        GameObject.Find("GameControl").GetComponent<Strength_Minigame_2>().wrongMiss();
        Destroy(gameObject); 
    }
}
