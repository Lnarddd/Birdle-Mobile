...
public class Hard_Target_2 : MonoBehaviour
{
    ...
    private void OnMouseDown() {
        ...
        GameObject.Find("GameControl").GetComponent<Strength_Minigame_3>().hit();
    ...
    public void KillSelf() {
        GameObject.Find("GameControl").GetComponent<Strength_Minigame_3>().spawntargets += 1;
        GameObject.Find("GameControl").GetComponent<Strength_Minigame_3>().itemtoremove = tagnumber;
        GameObject.Find("GameControl").GetComponent<Strength_Minigame_3>().hitMiss();
        Destroy(gameObject); 
    }
}
